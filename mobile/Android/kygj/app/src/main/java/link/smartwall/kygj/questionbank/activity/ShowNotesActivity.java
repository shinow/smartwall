...
import link.smartwall.kygj.questionbank.adapter.notes.NotesQuestionAdapter;
...
public class ShowNotesActivity extends AppCompatActivity {
    ...
    private NotesQuestionAdapter mAdapter;
 ...
 */
    private void initSubjects() {
        ...
        List<Subject> subjects = LocalDataReader.readNotesSubjects();
        itemList.clear();
        if (subjects != null) {
    ...
    private void setData() {
        ...
        mAdapter = new NotesQuestionAdapter(this, itemList);
