...
public class LikedSubjectViewHolder extends BaseViewHolder {
    ...
    public LikedSubjectViewHolder(Context context, View itemView) {
        super(itemView);
            ...
            public void onClick(View view) {
                if (listener != null) {
                    if (!subject.isChildLoaded()) {
                        ...
                        subject.setChapters(LocalDataReader.readLikedChapters(subject));
                    }

                    ItemData itemData = EncapsulationItem.likedItemData;
                    if (itemData != null && !subject.getGuid().equals(itemData.getSubject().getGuid())) {
                        ...
                        EncapsulationItem.likedItemData = null;
                    }
                    ...
                    if (subject.isExpand()) {
                        ...
                        EncapsulationItem.likedItemData = newItemData;
