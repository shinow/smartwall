...
public class RecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public RecyclerAdapter(Context context, List<Chapter> dataBeanList) {
    ...
    private ItemClickListener itemClickListener = new ItemClickListener() {
        @Override
        public void onExpandChildren(Chapter bean) {
            int position = getCurrentPosition(bean.getID());//确定当前点击的item位置
            Chapter children = getChildDataBean(bean);//获取要展示的子布局数据对象，注意区分onHideChildren方法中的getChildBean()。
            if (children == null) {
                return;
            }
        ...
        @Override
        public void onHideChildren(Chapter bean) {
            int position = getCurrentPosition(bean.getID());//确定当前点击的item位置
            Chapter children = bean.getChildBean();//获取子布局对象
            if (children == null) {
                return;
            }
     ...
     * @param position
     */
    public void add(Chapter bean, int position) {
     ...
     * @return
     */
    private Chapter getChildDataBean(Chapter bean){
