...
public class ErrorSubjectViewHolder extends BaseViewHolder {
    ...
    public ErrorSubjectViewHolder(Context context, View itemView) {
        super(itemView);
            ...
            public void onClick(View view) {
                if (listener != null) {
                    if (!subject.isChildLoaded()) {
                        ...
                        subject.setChapters(LocalDataReader.readErrosChapters(subject));
                    }

                    ItemData itemData = EncapsulationItem.errorItemData;
                    if (itemData != null && !subject.getGuid().equals(itemData.getSubject().getGuid())) {
                        ...
                        EncapsulationItem.errorItemData = null;
                    }
                    ...
                    if (subject.isExpand()) {
                        ...
                        EncapsulationItem.errorItemData = newItemData;
