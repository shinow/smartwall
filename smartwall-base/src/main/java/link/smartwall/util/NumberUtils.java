...
public final class NumberUtils {
     ...
     * @return 如果为0则为true
     */
    public static boolean isZeroValue2(double value) {
     ...
     * @return 返回值
     */
    public static String formatValueThousandsInt(double value) {
        DecimalFormat df = new DecimalFormat("#,##0");
        return df.format(value);
    }
     ...
     * @return 返回值
     */
    public static String formatValueThousands1(double value) {
        DecimalFormat df = new DecimalFormat("#,##0.0");
        return df.format(value);
    }
     ...
     * @return 返回值
     */
    public static String formatValueThousands2(double value) {
        DecimalFormat df = new DecimalFormat("#,##0.00");
        return df.format(value);
    }
     ...
     * @return 返回值
     */
    public static String formatValueThousands3(double value) {
        DecimalFormat df = new DecimalFormat("#,##0.000");
        return df.format(value);
    }
     ...
     * @return 返回值
     */
    public static String formatValueThousands4(double value) {
        DecimalFormat df = new DecimalFormat("#,##0.0000");
        return df.format(value);
    }
     ...
     * @return 返回值
     */
    public static String formatValueThousands5(double value) {
        DecimalFormat df = new DecimalFormat("#,##0.00000");
        return df.format(value);
    }
     ...
     * @return 返回值
     */
    public static String formatValueThousands6(double value) {
        DecimalFormat df = new DecimalFormat("#,##0.000000");
        return df.format(value);
    }
     ...
     * @return 格式串
     */
    public static String formatValueThousands(double value, int precision) {
        switch (precision) {
        case PRECISION_0:
            return formatValueThousandsInt(value);
        case PRECISION_1:
            return formatValueThousands1(value);
        case PRECISION_2:
            return formatValueThousands2(value);
        case PRECISION_3:
            return formatValueThousands3(value);
        case PRECISION_4:
            return formatValueThousands4(value);
        case PRECISION_5:
            return formatValueThousands5(value);
        case PRECISION_6:
            return formatValueThousands6(value);
        default:
            return formatValueThousandsInt(value);
        }
    }
