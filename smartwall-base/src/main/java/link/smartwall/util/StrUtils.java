...
public final class StrUtils {
     ...
     * @return 增加了分隔符的字符串
     */
    public static String join(int[] arrO, String delimiter) {
        int arrSize;
     ...
     * 如:StringUtils.join(new String[]{"A","B","C"}, ",") = "A,B,C"
     *
     * @param arrO long类型的数组
     * @param delimiter 分割符
     * @return 增加了分隔符的字符串
     */
    public static String join(long[] arrO, String delimiter) {
        int arrSize;
     ...
     * @return 增加了分隔符的字符串
     */
    public static String assemblyString(String str, String delimiter) {
        ...
        return StrUtils.join(result, delimiter);
    }
    ...
    public static String inputStreamToString(InputStream is) {
        try (ByteArrayOutputStream os = new ByteArrayOutputStream(DEF_BUFFER_SIZE); InputStream iis = is) {
            byte[] data = new byte[DEF_BUFFER_SIZE];
            int n = -1;
            while ((n = iis.read(data)) != -1) {
                os.write(data, 0, n);
            }
