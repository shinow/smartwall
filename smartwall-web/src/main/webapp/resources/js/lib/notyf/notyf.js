(function() {
   ...
   * Shows an alert card
   */
  this._Notyf.prototype.alert = function(alertMessage) {
   ...
   */
  this._Notyf.prototype.confirm = function(alertMessage) {
