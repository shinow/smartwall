		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				var datetimepicker = $('<div '+(options.id?'id="'+options.id+'"':'')+' '+(options.style?'style="'+options.style+'"':'')+' class="xdsoft_datetimepicker xdsoft_noselect '+options.className+'"></div>'),
					...
					mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev" title="上月"></button><button type="button" class="xdsoft_today_button" title="今天"></button><div class="xdsoft_label xdsoft_month"><span title="选择月份"></span></div><div class="xdsoft_label xdsoft_year"  title="选择年"><span></span></div><button type="button" class="xdsoft_next" title="下月"></button></div>'),
...
(function($) {
        ...
        var defaultOp = {
            create: function(container, editParm, controlOptions) {
                ...
                if (editParm.field) {
                    ...
                    if ($.inArray(type, ["select", "combobox", "autocomplete", "popup", "mapselectpos"]) != -1) {
                        txtInputName = field.textField || field.comboboxName;
                        if (field.comboboxName && !field.id)
                            p.id = (options.prefixID || "") + field.comboboxName;
                    }
                    if ($.inArray(type, ["select", "combobox", "autocomplete", "popup", "radiolist", "checkboxlist", "listbox", "mapselectpos"]) != -1) {
    ...
    liger.editors["mapselectpos"] = liger.editors["mapselectpos"];
    ...
    liger.inject = {
        ...
        */
        defaults: {
            ...
            Form_editor: 'ComboBox,DateEditor,Spinner,TextBox,PopupEdit,CheckBoxList,RadioList,Form_editor,MapSelectPosEdit',
            Form_grid: 'Grid',
            Form_columns: 'Grid_columns',
            Form_condition: 'Form',
            Form_popup: 'PopupEdit',
            Form_mapselectpos: 'MapSelectPosEdit',
            Form_buttons: 'Button',
            Portal_panel: 'Panel'
        },
        /*
...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        setHeight: function (height)
        {
            ...
            $("> .l-accordion-content", g.accordion).height(height - 6);
        }
    });
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function() {
            ...
            g.link.hover(function() {
                ...
                g.inputText.datetimepicker("show");
            });
            //不可用属性时处理
            if (p.disabled) {
...
(function($) {
    ...
    $.ligerDefaults.Filter.editors['date'] = {
        create: function(container, field) {
            var input = $("<input type='text'/>");
            container.append(input);
            input.ligerDateEditor(field.field.editor.options || {});
            return input;
        },
        setValue: function(input, value) {
...
(function($) {
    ...
    $.ligerDefaults.Form.parse = function(code) {
        try {
            if (code == null) return null;
            return new Function("return " + code + ";")();
        } catch (e) {
    ...
    $.ligerDefaults.Form.editorBulider = function(jinput) {
        ...
        if (jinput.attr("data-options")) {
            var opts = $.ligerDefaults.Form.parse("{" + jinput.attr("data-options") + "}");
            ...
            if (jinput.is(":text")) {
                switch (ltype) {
                    ...
                    case "popup":
                        ...
                        break;
                    case "mapselectpos":
                        control = jinput.ligerMapSelectPosEdit(options);
                        break;
                    case "currency":
            ...
            function setDataToFields(fields, tabIndex) {
                $(fields).each(function(fieldIndex, field) {
                    ...
                    if (name.indexOf("___") > -1) {
                        var ns = name.split("___");
                        if (ns[0] in g.data) {
                            var value = g.data[ns[0]] + "," + g.data[ns[1]];
...
(function($) {
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function() {
            ...
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'>");
            gridhtmlarr.push("                     <div class='l-bar-button l-bar-btnexp'><span></span></div>");
            ...
            g.gridbody.scroll(function(){if(p.enabledEdit){
            	g.endEdit();
            }});
            //处理autoFilter
            if (p.autoFilter) {
        ...
        */
        ...
        _fixHeight: function() {
            ...
            for (var rowid in g.records) {
                ...
                /*如果不加1，固定列显示不对，不知道为什么*/
                $(cell1).add(cell2).height(height + 1);
            }
        },
        ...
        select: function(rowParm) {
			...
			* create by yuety;
			*/
            if( g.selected.indexOf(rowdata)< 0){
...
(function($) {
    ...
    $.fn.ligerMapSelectPosEdit = function(options) {
        return $.ligerui.run.call(this, "ligerMapSelectPosEdit", arguments);
    };

    $.fn.ligerGetMapSelectPosEditManager = function() {
        return $.ligerui.run.call(this, "ligerGetMapSelectPosEditManager", arguments);
    };

    $.ligerDefaults.MapSelectPosEdit = {
    ...
    //扩展方法
    $.ligerMethos.MapSelectPosEdit = $.ligerMethos.MapSelectPosEdit || {};

    $.ligerui.controls.MapSelectPosEdit = function(element, options) {
        $.ligerui.controls.MapSelectPosEdit.base.constructor.call(this, element, options);
    };
    $.ligerui.controls.MapSelectPosEdit.ligerExtend($.ligerui.controls.Input, {
        __getType: function() {
            return 'MapSelectPosEdit';
        },
        _extendMethods: function() {
            return $.ligerMethos.MapSelectPosEdit;
        },
        _init: function() {
            $.ligerui.controls.MapSelectPosEdit.base._init.call(this);
        },
        _render: function() {
            var g = this,
                p = this.options;
        ...
        _initMap: function() {
            ...
            this.bind('buttonClick', function() {
                if (!g.popupFn) {
                    g.popupFn = $.ligerui.getMapSelectPosFn(g);
                }
                g.popupFn();
            });
        }
    ...
    //创建一个地图选择、需要外部包含leaflet.js的引用
    $.ligerui.getMapSelectPosFn = function(p) {
        var win;
        return function() {
            show();
            return false;
        ...
        function show() {
            if (!win) {
                ...
                win = $.ligerDialog.open({
                    ...
                    width: 700,
                    height: 420,
                    url: "/sfa/map/leaflet/select_lng_lat.mvc",
                    isResize: true,
                    cls: 'l-selectorwin',
                    buttons: [{
                        text: '选择',
            ...
            if (v) {
                setTimeout(function() {
                    ...
                    __setLatLng(v); /*这个函数来源selectLngLat.js*/
                }, 500);
            }
        ...
        function toSelect() {
            var latlng = __getLatLng(); /*这个函数来源selectLngLat.js*/
            var result = latlng.lng + "," + latlng.lat;
                ...
                if (!g.popupFn)
                {
                    var options = {
                        ...
                        onSelect: function (e)
                        {
                             ...
                             * at 2017.2.17
                             */
                            if (p.grid.checkbox && !p.grid.isSingleCheck)
                            {
                                g.addValue(e.value, e.text);
                                g.removeValue(e.remvoeValue, e.remvoeText);
                            } else if(p.grid.checkbox && p.grid.isSingleCheck){
								g.setValue(e.value);
                                g.setText(e.text);
							} else
                            {
 ...
 * Author lexloo 2016 [ lexloo@126.com ] 
 * 
 */
(function($) {
    //创建一个可查询、可分页列表的选取弹出框 需要dialog,grid,form等插件的支持
    $.ligerui.PopupSelect = function(p, master) {
        p = $.extend({
            title:'选择', //窗口标题
            width: 700, //窗口宽度     
            height: 320, //列表高度
        ...
        if (!p.grid) return;
        var win, grid, condition, selected = [],
            lastSelected = p.lastSelected || [];
            if(p.initSelected && p.initSelected.length > 0){
              $.each(p.initSelected, function(){
                        selected.push(this["guid"]);
                      });
            }
        ...
        function addSelected(guid) {
            if (findSelected(guid) == -1)
                selected.push(guid);
        };

        function removeSelected(guid) {
            var i = findSelected(guid);
            if (i == -1) return;
            selected.splice(i, 1);
        };
        ...
        function show() {
            ...
            var gridParm = $.extend({
                ...
                onCheckRow: function(checked, data) {
                    if (checked) addSelected(data.guid);
                    else removeSelected(data.guid);
                },
                onCheckAllRow: function(checked, element) {
                    for (var rowid in this.records) {
                        if (checked)
                            addSelected(this.records[rowid]['guid']);
                        else
                            removeSelected(this.records[rowid]['guid']);
                    }
                }
            });
            //grid
            grid = gridPanel.ligerGrid(gridParm);
//            $.each(grid.selected.concat(), function() {
//                selected.push(this["guid"]);
//            });
            //搜索按钮
            if (p.condition) {
...
(function ($)
{
    ...
    $.ligerui.controls.RadioList.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            g.radioList.html('<div class="l-radiolist-inner"><table cellpadding="0" cellspacing="0" border="0" width="'+p.width+'" class="l-radiolist-table"></table></div>').addClass("l-radiolist").append(g.valueField);
