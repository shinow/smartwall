...
<head>
	...
	<!-- load css -->
	<link rel="stylesheet" type="text/css" href="resources/js/lib/layui/css/layui.css" media="all">
	<link rel="stylesheet" type="text/css" href="resources/css/global.css" media="all">
		...
		<div class="layui-main">
            ...
            <ul class="layui-nav larry-header-item">
            		<li class="layui-nav-item first">
						<a href="javascript:;">
							<img src="resources/images/userimg.jpg" class="userimg">			
							<cite>默认站点</cite>
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<div class="user-photo">
			<a class="img" title="我的头像" >
				<img src="resources/images/user.jpg" class="userimg1"></a>
			<p>你好！admin, 欢迎登录</p>
		</div>
		<!-- 左侧菜单 -->
	...
	<div class="layui-footer layui-larry-foot" id="larry-footer">
		<div class="layui-mian">
		    <div class="larry-footer-left">
		    	LarryCMS QQ群：
		    	<a href="https://jq.qq.com/?_wv=1027&k=42fC4vT"><img border="0" src="resources/images/group.png" title="LarryCMS官方交流群"></a>
...
<!-- 加载js文件-->
<script type="text/javascript" src="resources/js/lib/layui/lay/lib/jquery.js"></script> 
<script type="text/javascript" src="resources/js/lib/layui/layui.js"></script> 
<script type="text/javascript" src="resources/js/kyapp/larry.js"></script>
<script type="text/javascript" src="resources/js/kyapp/index.js"></script>
<!-- 锁屏 -->
<div class="lock-screen" style="display: none;">
	<div id="locker" class="lock-wrapper">
		<div id="time"></div>
		<div class="lock-box center">
			<img src="resources/images/userimg.jpg" alt="">
			<h1>admin</h1>
