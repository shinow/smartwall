...
<template>
    <div class="designer">
        <SubjectSelector @on-select-subject='onSelectSubject'></SubjectSelector>
        <div>
    ...
    export default {
        ...
        methods: {
            ...
            loadQuestions(guid) {
                ...
                data.getSubjectQuestions(guid).then(function(req) {
                    if (req) {
            ...
            saveQuestions() {
                data.saveSubjectQuestions(this.chapterGuid, JSON.stringify(this.items)).then(function(req) {
                    alert("保存完成");
                });
            },
