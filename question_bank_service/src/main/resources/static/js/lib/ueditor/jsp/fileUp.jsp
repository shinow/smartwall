<%@page import="com.jccatech.biz.common.entity.Uploader" %>
...
<%
    ...
    String[] fileType = {".xls", ".xsls", ".ppt", ".pptx",".rar", ".doc", ".docx", ".zip", ".pdf", ".txt", ".swf", ".wmv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4"};  //允许的文件类型
