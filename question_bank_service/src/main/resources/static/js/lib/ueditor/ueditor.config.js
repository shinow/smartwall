...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,savePath: [ 'noticeResources/images']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        //附件上传配置区
        , fileUrl: getContextPath() + "notice/fileUp.mvc"               //附件上传提交地址
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl', 'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'template', 'background', '|',
//               王博修改：默认去掉视频、音频、以及附件。如需开启，则将上面那句话注释掉，并去掉下面这句话的注释
